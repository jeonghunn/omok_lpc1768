...
C_SRCS += \
../src/TCP/portable/NetworkInterface/Common/phyHandling.c 

OBJS += \
./src/TCP/portable/NetworkInterface/Common/phyHandling.o 

C_DEPS += \
./src/TCP/portable/NetworkInterface/Common/phyHandling.d 


# Each subdirectory must supply rules for building sources it contributes
src/TCP/portable/NetworkInterface/Common/%.o: ../src/TCP/portable/NetworkInterface/Common/%.c
	@echo 'Building file: $<'
