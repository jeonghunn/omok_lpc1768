...
C_SRCS += \
../src/TCP/portable/NetworkInterface/SH2A/NetworkInterface.c 

OBJS += \
./src/TCP/portable/NetworkInterface/SH2A/NetworkInterface.o 

C_DEPS += \
./src/TCP/portable/NetworkInterface/SH2A/NetworkInterface.d 


# Each subdirectory must supply rules for building sources it contributes
src/TCP/portable/NetworkInterface/SH2A/%.o: ../src/TCP/portable/NetworkInterface/SH2A/%.c
	@echo 'Building file: $<'
